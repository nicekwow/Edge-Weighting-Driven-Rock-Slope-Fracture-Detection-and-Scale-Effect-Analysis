...
class SegLocalVisualizer(Visualizer):
    ...
    def _draw_sem_seg(self,
                      ...
                      with_labels: Optional[bool] = False) -> np.ndarray: #with_labels: Optional[bool] = True) -> np.ndarray:
    ...
    def add_datasample(
            ...
            step: int = 0,
            with_labels: Optional[bool] = False) -> None:#with_labels: Optional[bool] = True) -> None:
